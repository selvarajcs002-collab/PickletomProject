...
export const profileService = {
  ...
  uploadSingle: async (fileUri: string, fileType: "profile" | "cover", userId: number) => {
    const formData = new FormData();
  ...
  uploadMultiple: async (fileUris: string[], userId: number) => {
    const formData = new FormData();
    ...
    formData.append("mediaType", "profile_add");
    formData.append("userId", userId.toString());
